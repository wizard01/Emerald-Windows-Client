...
namespace TerraViewer
{
    public class Earth3d : Form, IScriptable
    {
        ...
        {
            if (UiTools.ShowMessageBox(Language.GetLocalizedText(1043, "Multiverse must restart for new settings to take effect. Do you want to restart now?"), Language.GetLocalizedText(694, "Restart Now?"), MessageBoxButtons.YesNoCancel) == DialogResult.Yes)
            {
                LanguageReboot = true;
                this.Close();
            }
